 ...
 */
#define USB_CFG_VENDOR_NAME     'g', 'r', 'e', 'u', 'e', 'l', '.', 'o', 'r', 'g'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'R', '/', 'C', ' ', 't', 'o', ' ', 'P', 'C', ' ', 'J', 'o', 'y', 's', 't', 'i', 'c', 'k'
#define USB_CFG_DEVICE_NAME_LEN 18
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USB-IDs-for-free.txt before you assign a name if
 * you use a shared VID/PID.
 */
#define USB_CFG_SERIAL_NUMBER   'g', 'r', 'e', 'u', 'e', 'l', '.', 'o', 'r', 'g', ':', 'h', 'i', 'd', 'r', 'c', 'j', 'o', 'y'
 ...
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    112
